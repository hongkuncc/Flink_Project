package com.hongkuncc.sparkmall.mock

import java.text.SimpleDateFormat
import java.util.UUID

import com.hongkuncc.sparkmall.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.hongkuncc.sparkmall.common.util.ConfigurationUtil
import com.hongkuncc.sparkmall.mock.util.{RandomDate, RandomNumUtil, RandomOptions}
